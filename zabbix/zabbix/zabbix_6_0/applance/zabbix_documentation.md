...
|:--------------|:------------|
| **Select an Image** | CentOS 8 Stream is currently the only image supported by the Zabbix Marketplace App, and it is pre-selected on the Linode creation page. *Required*. |
...
- [Learn from Zabbix Documentation](https://www.zabbix.com/documentation/6.0/manual)
- [Purchase Technical Support Contract](https://www.zabbix.com/support)
